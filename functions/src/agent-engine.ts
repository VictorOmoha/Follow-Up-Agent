...
export function createAgentEngine(options: EngineOptions = {}) {
  ...
  return { createLead, approveMessage, runDueTasks, runAutonomousCycle, connectEmailInbox, syncEmailInbox, recordReply, ingestInboundEmail, addTimelineEvent, prepareRetentionDraft, recordRetentionOutcome, getState, flushPersistence, reset };
}
